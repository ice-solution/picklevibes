  ...
  try {
    ...
    await Court.findOneAndUpdate(
      { number: 1 },
      {
        ...
        capacity: 8,
        amenities: ['air_conditioning', 'lighting', 'net', 'shower', 'vending_machine'],
        operatingHours: {
    ...
    courts.forEach(court => {
      console.log(`- ${court.name} (${court.type}) - ${court.capacity}人 - ${court.operatingHours.monday.start}-${court.operatingHours.monday.end}`);
    });
