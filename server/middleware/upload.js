...
// 申請表 banner（保留比例，限制最大寬度）
const applicationFormUpload = createUploadConfig('application-forms', 'app-form');
const processApplicationFormImage = async (req, res, next) => {
  try {
    if (!req.file) return next();
