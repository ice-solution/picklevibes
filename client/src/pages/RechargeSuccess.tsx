...
const RechargeSuccess: React.FC = () => {
  ...
  const balanceUrl = storeSlug
    ? `${PICKCOURT_ACCOUNT.balance}?store=${encodeURIComponent(storeSlug)}`
    : PICKCOURT_ACCOUNT.balance;
  const rechargeUrl = storeSlug
    ? `${PICKCOURT_ACCOUNT.recharge}?store=${encodeURIComponent(storeSlug)}`
    : PICKCOURT_ACCOUNT.recharge;
